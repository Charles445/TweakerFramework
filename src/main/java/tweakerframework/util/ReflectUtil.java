...
public class ReflectUtil
{
	...
	public static Field findFieldAnyOrNull(Class clazz, String nameA, String nameB)
	{
		...
		{
			TweakerFramework.logger.error("findFieldAnyOrNull failure for: "+nameA+" and "+nameB);
			return null;
		}
	}
	...
	public static Field findFieldOrNull(Class clazz, String nameA)
	{
		...
		{
			TweakerFramework.logger.error("findFieldOrNull failure for: "+nameA);
			return null;
		}
	}
	...
	public static Class findClassOrNull(String cfn)
	{
		...
		{
			TweakerFramework.logger.error("findClassOrNull failure for: "+cfn);
			return null;
		}
	}
	...
	public static Method findMethodOrNull(Class clazz, String name)
	{
		...
		{
			TweakerFramework.logger.error("findMethodOrNull failure for: "+clazz==null?"null":clazz.getName()+" "+name);
			return null;
		}
	}
